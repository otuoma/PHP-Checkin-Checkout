...
<html lang="en">
<head>
    <title>CHECKIN-CHECKOUT REPORTS:: <?php echo $this->options_model->get_option('company_name');?></title>
...
<div id="content_wrapper">
 ...
 <?php $this->load->view("common/header.php"); ?>
	...
	<div id="body"><div style="text-align: center;"><h2 style="display:inline;">Checkin Checkout Reports</h2></div>
        <div id="msg-box"></div>
        ...
        <div id="tbl-holder" style="padding:5px;">
            <h4> Use the form above to generate a report. </h4>
        </div><!--end tbl-holder //-->

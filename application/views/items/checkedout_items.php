...
<html lang="en">
<head>
    <title>CHECKED-OUT:: <?php echo $this->options_model->get_option('company_name');?></title>
    ...
    <script src="<?php echo base_url(); ?>js/jquery/datepicker/jquery.ui.widget.js"></script>
    <style type="text/css">
	...
	//$( "#datepicker" ).datepicker({ dateFormat: "yy-mm-dd" });
            ...
            $("input#item_unique_id").keyup(
                ...
                function () { 
                    ...
                    var URL = "<?php echo base_url(); ?>index.php/items/checkedout_livesearch/";
...
<div id="content_wrapper">
  ...
  <div id="body">
        <div style="text-align: center;"><h2 style="display:inline;">Checked out Items</h2></div>
        <div id="msg-box"></div>
        <div style="padding:5px; background:#ccc; margin:4px;">
            <form id="search_form" method="post">
                Between <input type="text" name="dateone" id="dateone" size="10">
                and <input type="text" id="datetwo" name="datetwo" size="10"> &nbsp; &nbsp;
                    ...
                    ?><tr>
                            ...
                            <td>
                                ...
                                <?php if($item['checkout_person_id'] !== $person_detail['unique_id']){
                                    echo "<span style='color:red;' title='item checked out by person who is not the registered owner'>";
                                }?>

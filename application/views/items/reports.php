...
<html lang="en">
<head>
    <title>ITEM REPORT::<?php echo $this->options_model->get_option('company_name');?></title>
        ...
        $(document).ready(function(){
           ...
           $('#fetch_form').submit(function(){
               ...
               $.ajax({
                   ...
                   type: "POST",
                   data: formVals,
                   success: function(response) {$('#tbl-holder').html(response); }
               });
            return false;
           });
...
<div id="content_wrapper">
   ...
   <div id="body">
        <div style="text-align: center;">
            <h2 style="display:inline;">Reports for Registered Items. </h2>
        </div>
        <div id="msg-box"></div>
        ...
        <div id="tbl-holder" style="padding:5px;">
            <h3> Use the form above to generate reports. </h3>
        </div><!--end tbl-holder //-->

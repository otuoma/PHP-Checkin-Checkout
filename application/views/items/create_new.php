...
<html lang="en">
<head>
    <title>CREATE ITEM:: <?php echo $this->options_model->get_option('company_name');?></title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function(){
           ...
           $("form#items_form").submit(function(){
                ...
                var URL = "<?php echo base_url();?>index.php/items/save_new_item";
                $.ajax({
                    url: URL,
                    cache: false,
                    type: "POST",
...
<div id="content_wrapper">
	...
	<div id="body">
        <div style="text-align: center;"><h2 style="display:inline;">Create New Item</h2></div>
        <div id="msg-box"></div>
             ...
             <fieldset><legend>ITEM DETAILS</legend>
                 <table>
                     <tr>
                         <td>Item ID</td>
                         <td>
                             <input type="text" id="unique_id" name="unique_id" value="<?php echo set_value('unique_id'); ?>">
                         </td>
                     </tr>
                 ...
                 <p>
                    <input type="submit" value="create item" /> &nbsp; &nbsp; <input type="reset" value="cancel">
                 </p>
             </fieldset>
        </form>
    </div>
